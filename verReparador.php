                ...
                <div class="col-lg-12 col-md-12 col-sm-12 px-2 mt-1 ">
                    <div class="">
                        ...
                        <div class="card-body ">
                            ...
                            <h2 class="text-center"><i class="bi bi-eye-fill"></i> Información del reparador</h2>
                            <p class="text-center">La información que ven a continuación solo es informativa</p>
                                            ...
                                            <form method="POST" class="was-validated">
                                                <div class="modal-body text-left bg-light shadow p-3 mb-5 bg-white rounded">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="identificacion" class="form-control" placeholder="Identificación" style="text-transform: capitalize;" value="<?php echo $identificacion; ?>" required="true" readonly>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="nombre" class="form-control" placeholder="Nombre completo" style="text-transform: capitalize;" value="<?php echo $nombre; ?>" required="true" readonly>
                                                    </div>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="telefono" class="form-control" placeholder="Teléfono" value="<?php echo $telefono; ?>" style="text-transform: capitalize;" required="true" readonly>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="email" name="email" id="email" class="form-control" placeholder="Correo electrónico" value="<?php echo $email; ?>" required="true" readonly>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select name="profesion" class="form-control form-select-lg custom-selec text-bg-dark" required="true" readonly>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select name="estado" class="form-control form-select-lg custom-selec text-bg-dark" required="true" readonly>
                                                    ...
                                                    <a href="viewReparaciones.php" class="btn btn-outline-info w-100">
