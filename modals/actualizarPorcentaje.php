<?php
$ipc = mysqli_query($con, "SELECT * FROM porcentajeAumento WHERE id=1");
...
if (isset($_POST['updateIPC'])) {
    ...
    $sqlPorcentaje = "UPDATE porcentajeAumento SET porcentaje = '$porcentajeNuevo' WHERE id = 1";
...
<form method="post" class="was-validated"">
    ...
    <div class=" modal fade" id="actualizarPrecio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header text-white" style="background:#123960;">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-percent"></i> ACTUALIZACIÓN DE IPC DE AUMENTO</h5>
