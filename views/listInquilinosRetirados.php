        ...
        <table id="testTable" class=" table table-sm table-hover table-bordered table-lg table-responsive">
            <thead class="thead-dark">
                ...
                <th style="width: 100px;">V </th>
                    ...
                    <th style="width: 150px;">No contrato servicios</th>
            ...
            <tbody>
                ...
                if ($filter) {
                    ...
                    $sql = mysqli_query($con, "SELECT * FROM tenant INNER JOIN proprieter ON proprieter.codigo = tenant.codigoPropiedad ORDER BY fechaRetiro DESC"); 
                } else {
                    $sql = mysqli_query($con, "SELECT * FROM tenant INNER JOIN proprieter ON proprieter.codigo = tenant.codigoPropiedad ORDER BY fechaRetiro DESC"); 
                }
