...
<div class="card bg-dark text-white">
    <img src="images/SIVPS.png" class="card-img " alt="enccabezado" height="180px">
    <div class="container">
        <div class="card-img-overlay ">
            ...
            <?php
                               ...
                               while ($userLog = mysqli_fetch_array($query)) {
                                echo '<h5  class="card-text px-2 mt-1 ">'.$userLog['nombre'].' <div class="spinner-grow text-success spinner-grow-sm" role="status">
