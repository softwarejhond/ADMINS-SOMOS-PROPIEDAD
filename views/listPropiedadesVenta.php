<div class="card text-center">
    ...
    <i class="bi bi-houses-fill"></i> LISTA DE PROPIEDADES EN VENTA <i class="bi bi-houses-fill"></i>
    </div>
    <div class="card-body">
        <table id="myTableVenta" class=" table table-sm table-hover table-bordered table-lg table-responsive">
            ...
            <tbody style="height: 300px;">
                ...
                if ($filter) {
                    ...
                    $sql = mysqli_query($con, "SELECT * FROM proprieter INNER JOIN municipios ON proprieter.Municipio = municipios.id_municipio WHERE codigo like '%$buscar%' AND nombre_inquilino='' AND estadoPropietario='ACTIVO' AND condicion='EN VENTA' ORDER BY nombre_propietario ASC");
                } else {
                    $sql = mysqli_query($con, "SELECT * FROM proprieter INNER JOIN municipios ON proprieter.Municipio = municipios.id_municipio WHERE codigo like '%$buscar%' AND nombre_inquilino='' AND estadoPropietario='ACTIVO' AND condicion='EN VENTA' ORDER BY nombre_propietario ASC");
                }
