            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 px-2 mt-1">
                    ...
                    <div class="">
                        ...
                        <?php include 'views/alertDeleteFechaProgramada.php';?>                       
                        <br>
                        <div class="p-3">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                        aria-controls="home" aria-selected="true">Retiros programados</a>
                                </li>
                               <!-- <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <?php include 'views/listRetirosProgramados.php';?>
                                </div>
