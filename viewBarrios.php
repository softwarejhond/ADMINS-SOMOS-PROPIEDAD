            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 px-2 mt-1">
                    ...
                    <div class="">
                        ...
                        <br>
                        <div class="p-3">
                        <?php include 'views/alertDeleteBarrio.php';?>
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                        aria-controls="home" aria-selected="true">Lista de barrios</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="#" data-toggle="modal" data-target="#exampleModal">
                                        <i class="bi bi-geo-alt-fill"></i><span class="badge badge-success ">⭐️
                                            Nuevo</span>
                                        <span class="links_name">Registrar barrio nuevo</span>
                                    </a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <?php include 'views/listaBarrios.php';?>
                                </div>
