...
if (isset($_GET['aksi']) == 'delete') {
    ...
    $cek = mysqli_query($con, "SELECT * FROM houses WHERE codigo='$nik'");
    if (mysqli_num_rows($cek) == 0) {
        echo '<div class="alert alert-info alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
    } else {
        $delete = mysqli_query($con, "DELETE FROM houses WHERE codigo='$nik'");
        if ($delete) {
            echo '
            <div class="toastPatient" style="position: absolute; top: 0; right: 0;" data-delay="4000">
                ...
                <div class="toast-body alert-danger">
                    <h5> <b>Vivienda eliminada correctamente</b></h5>
       ...
       '; } else {
        ...
        <div class="toastPatient" style="position: absolute; top: 0; right: 0;" data-delay="4000">
            ...
            <div class="toast-body alert-danger">
                <h5> <b>Hubo problemas al eliminar la vivienda</b></h5>
