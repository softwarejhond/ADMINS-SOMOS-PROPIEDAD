                ...
                <div class="col-lg-12 col-md-12 col-sm-12 px-2 mt-1">
                    ...
                    <div class="card border-info shadow p-3 mb-5 bg-white rounded">
                        ...
                        if (isset($_POST['addProprieter'])) {
                            ...
                            $ruta1 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta2 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen2"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta3 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen3"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta4 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen4"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta5 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen5"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta6 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen6"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta7 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen7"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta8 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen8"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta9 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen9"], ENT_QUOTES))); //Escanpando caracteres
                            $ruta10 = mysqli_real_escape_string($con, (strip_tags($_POST["imagen10"], ENT_QUOTES))); //Escanpando caracteres
                                                ...
                                                <div class="row">
                                                    <div class="col col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="v" id="y" value="Y" >
                                                                <label class="form-check-label" for="y">Y</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="v" id="h" value="H" >
                                                                <label class="form-check-label" for="h">H</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="v" id="v" value="V" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="codigo" class="form-control" placeholder="Código de la propiedad" value="<?php echo $username; ?>" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <br>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Casa" value="Casa" style="text-transform: capitalize;" >
                                                                <label class="form-check-label" for="Casa">Casa</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Apartamento" value="Apartamento" style="text-transform: capitalize;" >
                                                                <label class="form-check-label" for="Apartamento">Apartamento</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Local" value="Local" style="text-transform: capitalize;" >
                                                                <label class="form-check-label" for="Local">Local</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Local" value="Apartaestudio" style="text-transform: capitalize;" >
                                                                <label class="form-check-label" for="Local">Apartaestudio</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Local" value="Penthouse" style="text-transform: capitalize;" >
                                                                <label class="form-check-label" for="Local">Penthouse</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Local" value="Finca" style="text-transform: capitalize;" >
                                                                <label class="form-check-label" for="Local">Finca</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Local" value="Casa con local" style="text-transform: capitalize;" >
                                                                <label class="form-check-label" for="Local">Casa con
                                                                    local</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="tipo_vivienda" id="Local" value="LOTE" style="text-transform: capitalize;" >
                                                        ...
                                                        <div class="form-group">
                                                            <label style="color:#000">Titulo o nombre para la propiedad
                                                                *</label>
                                                            <input type="text" name="nombre" class="form-control" style="text-transform: capitalize;" placeholder="Nombre" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label style="color:#000">Nivel de piso *</label>

                                                            <select multiple class="form-control" id="exampleFormControlSelect2" name="nivel_piso" >
                                                    ...
                                                    <div class="col col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" class="form-control" name="area" placeholder="Área m² " aria-label="Username" aria-describedby="basic-addon1" >
                                                        </div>

                                                        <div class="form-group">
                                                            <label style="color:#000">Estrato *</label><br>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="estrato" id="1" value="1" >
                                                                <label class="form-check-label" for="1">1</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="estrato" id="2" value="2" >
                                                                <label class="form-check-label" for="2">2</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="estrato" id="3" value="3" >
                                                                <label class="form-check-label" for="3">3<label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="estrato" id="4" value="4" >
                                                                <label class="form-check-label" for="4">4</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="estrato" id="5" value="5" >
                                                                <label class="form-check-label" for="5">5</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="estrato" id="6" value="6" >
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="lista_departamento" name="departamento" class="form-control form-select-lg custom-selec text-bg-dark" ></select>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="municipios" name="municipio" class="form-control form-select-lg custom-selec text-bg-dark" ></select>
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <select id="barrios" name="barrio" class="form-control form-select-lg custom-selec text-bg-dark" ></select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="terraza" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="terraza" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                            <!--Ascensor-->
                                                            <label style="color:#000">Ascensor: *</label>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="ascensor" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="ascensor" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                            <!--patio-->
                                                            <label style="color:#000">Patio: *</label>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="patio" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="patio" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="parqueadero" id="Privado" value="Privado" >
                                                                <label class="form-check-label" for="Privado">Privado</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="parqueadero" id="Publico" value="Público" >
                                                                <label class="form-check-label" for="Publico">Público</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="parqueadero" id="No" value="Sin parqueadero" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cuarto_util" id="Si" value="Sí" >
                                                                <label class="form-check-label" for="Si">Sí</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cuarto_util" id="NO" value="NO" >
                                                                <label class="form-check-label" for="NO">NO</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col col-lg-4 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="0" value="0" >
                                                                <label class="form-check-label" for="0">0</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="1" value="1" >
                                                                <label class="form-check-label" for="1">1</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="2" value="2" >
                                                                <label class="form-check-label" for="2">2</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="3" value="3" >
                                                                <label class="form-check-label" for="3">3<label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="4" value="4" >
                                                                <label class="form-check-label" for="4">4</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="5" value="5" >
                                                                <label class="form-check-label" for="5">5</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="6" value="6" >
                                                                <label class="form-check-label" for="6">6</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="7" value="7" >
                                                                <label class="form-check-label" for="67">7</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="8" value="8" >
                                                                <label class="form-check-label" for="8">8</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="9" value="9" >
                                                                <label class="form-check-label" for="9">9</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="habitaciones" id="10" value="10" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="0" value="0" >
                                                                <label class="form-check-label" for="0">0</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="1" value="1" >
                                                                <label class="form-check-label" for="1">1</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="2" value="2" >
                                                                <label class="form-check-label" for="2">2</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="3" value="3" >
                                                                <label class="form-check-label" for="3">3<label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="4" value="4" >
                                                                <label class="form-check-label" for="4">4</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="5" value="5" >
                                                                <label class="form-check-label" for="5">5</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="6" value="6" >
                                                                <label class="form-check-label" for="6">6</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="7" value="7" >
                                                                <label class="form-check-label" for="67">7</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="8" value="8" >
                                                                <label class="form-check-label" for="8">8</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="9" value="9" >
                                                                <label class="form-check-label" for="9">9</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="closets" id="10" value="10" >
                                                                <label class="form-check-label" for="10">10</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="sala" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="sala" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="comedor" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="comedor" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="sala_comedor" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="sala_comedor" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col col-lg-4 col-md-12col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cocina" id="integral" value="Integral" >
                                                                <label class="form-check-label" for="integral">Integral</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cocina" id="semi-integral" value="Semi-integral" >
                                                                <label class="form-check-label" for="semi-integral">Semi-integral</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cocina" id="enchapada" value="Enchapada" >
                                                                <label class="form-check-label" for="enchapada">Enchapada</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cocina" id="basica" value="Basica" >
                                                                <label class="form-check-label" for="basica">Basica</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cocina" id="Noaplica" value="No aplica" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="servicios" id="1" value="1" >
                                                                <label class="form-check-label" for="1">1</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="servicios" id="2" value="2" >
                                                                <label class="form-check-label" for="2">2</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="servicios" id="3" value="3" >
                                                                <label class="form-check-label" for="3">3</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="servicios" id="4" value="4" >
                                                                <label class="form-check-label" for="4">4</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="servicios" id="5" value="5" >
                                                                <label class="form-check-label" for="5">5</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cuartoServicios" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="cuartoServicios" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="zonaRopa" id="si" value="SÍ" >
                                                                <label class="form-check-label" for="si">SÍ</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="zonaRopa" id="no" value="NO" >
                                                                <label class="form-check-label" for="no">NO</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="exampleFormControlSelect2" name="vista" >
                                                    ...
                                                    <div class="col col-lg-4 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control w-100" type="text" id="servicios_seleccionados" name="servicios_seleccionados" >
                                                        ...
                                                        <div class="form-group">
                                                            <label style="color:#000">Otras Caracteristicas
                                                                *</label><br>
                                                            <textarea name="otras_caracteristicas" rows="10" cols="50" ></textarea>
                                                            <br>
                                                    ...
                                                    <div class="col col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            <label style="color:#000">Dirección
                                                                *</label>
                                                            <input type="text" name="direccion" class="form-control" style="text-transform: capitalize;" placeholder="Dirección" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label style="color:#000">Teléfono del inmueble
                                                                *</label>
                                                            <input type="text" name="telefonoInmueble" class="form-control" placeholder="Teléfono del inmueble" minlength="10" maxlength="10" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label style="color:#000">Valor canon
                                                                *</label>
                                                            <input type="text" name="valor" class="form-control" placeholder="Valor canon" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label style="color:#000">Identificación del propietario
                                                                *</label>
                                                            <input type="number" name="identificacion_propietario" class="form-control" style="text-transform: uppercase;" placeholder="Identificación del propietario" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label style="color:#000">Nombre del propietario *</label>
                                                            <input type="text" name="nombre_propietario" class="form-control" style="text-transform: capitalize;" placeholder="Nombre del propietario" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label style="color:#000">Teléfono del propietario *</label>
                                                            <input type="text" name="telefono_propietario" class="form-control" placeholder="Teléfono del propietario" >
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col col-md-6 col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="epm" class="form-control" placeholder="Contrato EPM" >
                                                        </div>
                                                    ...
                                                    <div class="col col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="comision" class="form-control" placeholder="Comisión" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label style="color:#000">Aval Catastro *</label>
                                                            <input type="text" name="catastro" class="form-control" placeholder="Aval Catastro" >
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select name="condicion" class="form-control form-select-lg custom-selec text-bg-dark" >
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12 col-sm-12 px-2 mt-1 p-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen2" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen3" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen4" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen5" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12 col-sm-12 px-2 mt-1 p-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen6" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen7" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen8" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen9" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="imagen10" class="btn  w-100" style="background-color: #123960; color:#ffffff;" />
                                                        </div>
